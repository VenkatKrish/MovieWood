...
open class MovieControllerAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMovieByKeyPublicUsingGET(movie: String, completion: @escaping ((_ data: MoviePaymentStatus?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<MoviePaymentStatus> 
     */
    open class func getMovieByKeyPublicUsingGETWithRequestBuilder(movie: String) -> RequestBuilder<MoviePaymentStatus> {
        ...
        let requestBuilder: RequestBuilder<MoviePaymentStatus>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMovieByKeyUsingGET(movie: String, completion: @escaping ((_ data: MoviePaymentStatus?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<MoviePaymentStatus> 
     */
    open class func getMovieByKeyUsingGETWithRequestBuilder(movie: String) -> RequestBuilder<MoviePaymentStatus> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMovieUsingGET(movieId: Int64, completion: @escaping ((_ data: MoviePaymentStatus?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<MoviePaymentStatus> 
     */
    open class func getMovieUsingGETWithRequestBuilder(movieId: Int64) -> RequestBuilder<MoviePaymentStatus> {
        var path = "/api/v1/movies/{movieId}"
        let movieIdPreEscape = "\(movieId)"
        let movieIdPostEscape = movieIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{movieId}", with: movieIdPostEscape, options: .literal, range: nil)
    ...
    } // Updated 1 - ResponsEntity -> PageMovies
