...
open class UserControllerAPI {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func authenticateSocialUserUsingPOST(loginRequest: LoginRequest, completion: @escaping ((_ data: JSONValue?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<JSONValue> 
     */
    open class func authenticateSocialUserUsingPOSTWithRequestBuilder(loginRequest: LoginRequest) -> RequestBuilder<JSONValue> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func authenticateUserUsingPOST(loginRequest: LoginRequest, completion: @escaping ((_ data: JSONValue?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<JSONValue> 
     */
    open class func authenticateUserUsingPOSTWithRequestBuilder(loginRequest: LoginRequest) -> RequestBuilder<JSONValue> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getMyProfileUsingGET(completion: @escaping ((_ data: JSONValue?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<JSONValue> 
     */
    open class func getMyProfileUsingGETWithRequestBuilder() -> RequestBuilder<JSONValue> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func uploadImageUsingPOST(file: URL, userId: Int64, completion: @escaping ((_ data: JSONValue?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - returns: RequestBuilder<JSONValue> 
     */
    open class func uploadImageUsingPOSTWithRequestBuilder(file: URL, userId: Int64) -> RequestBuilder<JSONValue> {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func validatePhoneOTPUsingPOST(login: JSONValue, completion: @escaping ((_ data: JSONValue?,_ error: Error?) -> Void)) {
  ...
  "empty": false
     ...
     - returns: RequestBuilder<JSONValue> 
     */
    open class func validatePhoneOTPUsingPOSTWithRequestBuilder(login: JSONValue) -> RequestBuilder<JSONValue> {
