...
open class MovieControllerAPI {
    ...
    /**
     ...
     - returns: RequestBuilder<JSONValue> 
     */
    open class func getMovieVideoWUsingPOSTWithRequestBuilder(playMovieRequest: PlayMovieRequest) -> RequestBuilder<MovieLinkModel> {
        ...
        let requestBuilder: RequestBuilder<MovieLinkModel>.Type = SwaggerClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func streamingnowPublicUsingGET(language: String? = nil, offset: Int64? = nil, pageNumber: Int? = nil, pageSize: Int? = nil, paged: Bool? = nil, showinios: String? = nil, sortSorted: Bool? = nil, sortUnsorted: Bool? = nil, unpaged: Bool? = nil, contenttype:String? = nil, sort:String? = nil, completion: @escaping ((_ data: PageMoviePaymentStatus?,_ error: Error?) -> Void)) {
        streamingnowPublicUsingGETWithRequestBuilder(language: language, offset: offset, pageNumber: pageNumber, pageSize: pageSize, paged: paged, showinios: showinios, sortSorted: sortSorted, sortUnsorted: sortUnsorted, unpaged: unpaged, contenttype:contenttype, sort:sort).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<PageMoviePaymentStatus> 
     */
    open class func streamingnowPublicUsingGETWithRequestBuilder(language: String? = nil, offset: Int64? = nil, pageNumber: Int? = nil, pageSize: Int? = nil, paged: Bool? = nil, showinios: String? = nil, sortSorted: Bool? = nil, sortUnsorted: Bool? = nil, unpaged: Bool? = nil, contenttype:String? = nil, sort:String? = nil) -> RequestBuilder<PageMoviePaymentStatus> {
    ...
    open class func streamingnowUsingGET(language: String? = nil, offset: Int64? = nil, pageNumber: Int? = nil, pageSize: Int? = nil, paged: Bool? = nil, showinios: String? = nil, sortSorted: Bool? = nil, sortUnsorted: Bool? = nil, unpaged: Bool? = nil, contenttype:String? = nil, sort:String? = nil, completion: @escaping ((_ data: PageMoviePaymentStatus?,_ error: Error?) -> Void)) {
        streamingnowUsingGETWithRequestBuilder(language: language, offset: offset, pageNumber: pageNumber, pageSize: pageSize, paged: paged, showinios: showinios, sortSorted: sortSorted, sortUnsorted: sortUnsorted, unpaged: unpaged, contenttype: contenttype, sort:sort).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
    ...
    /**
     ...
     - returns: RequestBuilder<PageMoviePaymentStatus> 
     */
    open class func streamingnowUsingGETWithRequestBuilder(language: String? = nil, offset: Int64? = nil, pageNumber: Int? = nil, pageSize: Int? = nil, paged: Bool? = nil, showinios: String? = nil, sortSorted: Bool? = nil, sortUnsorted: Bool? = nil, unpaged: Bool? = nil, contenttype:String? = nil, sort:String? = nil) -> RequestBuilder<PageMoviePaymentStatus> {
