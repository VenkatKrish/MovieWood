...
//    
//    //Colors
//    let inactiveFieldBorderColor = UIColor.clear//UIColor(white: 1, alpha: 0.3)
//    let textBackgroundColor = UIColor.clear//UIColor(white: 1, alpha: 0.5)
//    let activeFieldBorderColor = UIColor.clear//UIColor.white
...
//        textField.font = UIFont.setAppFontBold(40)
